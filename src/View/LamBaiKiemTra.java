...
public class LamBaiKiemTra extends javax.swing.JFrame {
    ...
    public LamBaiKiemTra(String maBKT, String maSV) {
        initComponents();
        // A.setText("ok");
        //setLocationRelativeTo(null);
        this.maBKT = maBKT;
    ...
    void layDanhSachCauHoi() {
        ...
        listCauHoi = ConnectToSQLServer.layData_BangCauHoi(sql);
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ndCauHoi, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//    }
    ...
    void nopbai() {
        ...
        double soCauSVLamDc = (double) soCauSinhVienLamDung;
        ...
        if (ConnectToSQLServer.thucHienLenhSQL(sql)) {
            ...
            new MainSinhVienF(sinhVien.getTaiKhoan().getTenDangNhap()).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LamBaiKiemTra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LamBaiKiemTra("7", "SV1").setVisible(true);
            }
        });
    }
    ...
    private void layThongTinSinhVienDangLamBKT() {
        ...
        sinhVien = listSinhVien.get(0);
        
        sql = "SELECT * FROM CT_SV_BKT INNER JOIN SINHVIEN ON SINHVIEN.MaSV = CT_SV_BKT.MaSV " +
        ...
        chiTietBaiKiemTraDangLam = listBKT.get(0);
